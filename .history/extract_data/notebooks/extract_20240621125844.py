...
pdf_path = "../pdf/baldwing-catalog-training.pdf"
...
def pdf_to_images(pdf_path, output_dir="../pdf_images/"):
    ...
    for i, image in enumerate(images):
        image_filename = f"page_{i + 1}_baldwin.jpeg"
...
def extract_boundary_boxes(
    ...
    if yolo_boxes:
        with open(f"{training_boxes_dir}/page_{page_num}_baldwin.txt", "w") as file:
            file.write("\n".join(yolo_boxes))
